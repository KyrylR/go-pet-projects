...
func NewPxCanvas(state *apptype.State, config apptype.PxCanvasConfig) *PxCanvas {
	...
	pxCanvas.PixelData = NewBlankImage(pxCanvas.PxCols, pxCanvas.PxRows, color.NRGBA{R: 128, G: 128, B: 128, A: 255})
...
// MouseToCanvasXY Brushable interface
